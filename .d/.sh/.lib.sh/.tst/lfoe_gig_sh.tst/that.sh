...
fn_12651_25053(){
    ...
    local fl_pth_fn_12651_25053="${HOME}/aer_foe/.d/.sh/.lib.sh/.tst/lfoe_gig_sh.tst/that.sh"
    local dr_pth_fn_12651_25053=$(dirname ${HOME}/aer_foe/.d/.sh/.lib.sh/.tst/lfoe_gig_sh.tst/that.sh)
    local fl_nm_fn_12651_25053=$(basename ${HOME}/aer_foe/.d/.sh/.lib.sh/.tst/lfoe_gig_sh.tst/that.sh)
    local rnd=12651_25053
