...
fn_8943_5926(){
    ...
    local fl_pth_fn_8943_5926="${HOME}/aer_foe/.d/.sh/.lib.sh/.tst/lfoe_gig_sh.tst/that2.sh"
    local dr_pth_fn_8943_5926=$(dirname ${HOME}/aer_foe/.d/.sh/.lib.sh/.tst/lfoe_gig_sh.tst/that2.sh)
    local fl_nm_fn_8943_5926=$(basename ${HOME}/aer_foe/.d/.sh/.lib.sh/.tst/lfoe_gig_sh.tst/that2.sh)
    local rnd=8943_5926
