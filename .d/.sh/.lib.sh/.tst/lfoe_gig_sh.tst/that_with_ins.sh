...
fn_6459_8879(){
    ...
    local fl_pth_fn_6459_8879="${HOME}/aer_foe/.d/.sh/.lib.sh/.tst/lfoe_gig_sh.tst/that_with_ins.sh"
    local dr_pth_fn_6459_8879=$(dirname ${HOME}/aer_foe/.d/.sh/.lib.sh/.tst/lfoe_gig_sh.tst/that_with_ins.sh)
    local fl_nm_fn_6459_8879=$(basename ${HOME}/aer_foe/.d/.sh/.lib.sh/.tst/lfoe_gig_sh.tst/that_with_ins.sh)
    local rnd=6459_8879
