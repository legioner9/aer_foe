...
that2(){
    ...
    local fl_pth_fn_15692_31508="${HOME}/aer_foe/.d/.sh/.lib.sh/.tst/lfoe_gig_fn.tst/that2.sh"
    local dr_pth_fn_15692_31508=$(dirname ${HOME}/aer_foe/.d/.sh/.lib.sh/.tst/lfoe_gig_fn.tst/that2.sh)
    local fl_nm_fn_15692_31508=$(basename ${HOME}/aer_foe/.d/.sh/.lib.sh/.tst/lfoe_gig_fn.tst/that2.sh)
    local rnd=15692_31508
