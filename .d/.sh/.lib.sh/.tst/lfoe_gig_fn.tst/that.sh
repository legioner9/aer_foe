...
that(){
    ...
    local fl_pth_fn_2773_15355="${HOME}/aer_foe/.d/.sh/.lib.sh/.tst/lfoe_gig_fn.tst/that.sh"
    local dr_pth_fn_2773_15355=$(dirname ${HOME}/aer_foe/.d/.sh/.lib.sh/.tst/lfoe_gig_fn.tst/that.sh)
    local fl_nm_fn_2773_15355=$(basename ${HOME}/aer_foe/.d/.sh/.lib.sh/.tst/lfoe_gig_fn.tst/that.sh)
    local rnd=2773_15355
