...
that_with_ins(){
    ...
    local fl_pth_fn_903_13563="${HOME}/aer_foe/.d/.sh/.lib.sh/.tst/lfoe_gig_fn.tst/that_with_ins.sh"
    local dr_pth_fn_903_13563=$(dirname ${HOME}/aer_foe/.d/.sh/.lib.sh/.tst/lfoe_gig_fn.tst/that_with_ins.sh)
    local fl_nm_fn_903_13563=$(basename ${HOME}/aer_foe/.d/.sh/.lib.sh/.tst/lfoe_gig_fn.tst/that_with_ins.sh)
    local rnd=903_13563
