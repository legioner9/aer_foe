...
fn_vewthhg5231454gfvs() {
	...
	local repo_all_arr_234543htrbg=(aer_foe edu_clng edu_dta edu_lnx tml_a cmn_lex fns_bsh git_flw)
	local repo_any_arr_234543htrbg=(edu_clng edu_dta edu_lnx tml_a cmn_lex fns_bsh git_flw)
