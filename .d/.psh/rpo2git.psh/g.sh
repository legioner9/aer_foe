...
fn_29024_5735(){
    ...
    local fl_pth_fn_29024_5735="${HOME}/aer_foe/.d/.psh/rpo2git.psh/g.sh"
    local dr_pth_fn_29024_5735=$(dirname ${HOME}/aer_foe/.d/.psh/rpo2git.psh/g.sh)
    local fl_nm_fn_29024_5735=$(basename ${HOME}/aer_foe/.d/.psh/rpo2git.psh/g.sh)
    local rnd=29024_5735
