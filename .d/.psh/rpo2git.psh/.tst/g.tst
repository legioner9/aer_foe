...
fn_3072_1130(){
    ...
    local fl_pth_fn_3072_1130="${HOME}/aer_foe/.d/.psh/rpo2git.psh/.tst/g.tst"
    local dr_pth_fn_3072_1130=$(dirname ${HOME}/aer_foe/.d/.psh/rpo2git.psh/.tst/g.tst)
    local fl_nm_fn_3072_1130=$(basename ${HOME}/aer_foe/.d/.psh/rpo2git.psh/.tst/g.tst)
    local rnd=3072_1130
