...
fn_31209_29493() {
	...
	local fl_pth_fn_31209_29493="${HOME}/aer_foe/.d/.frp/make_011.frp/frp2dr.sh"
	local dr_pth_fn_31209_29493=$(dirname ${HOME}/aer_foe/.d/.frp/make_011.frp/frp2dr.sh)
	local fl_nm_fn_31209_29493=$(basename ${HOME}/aer_foe/.d/.frp/make_011.frp/frp2dr.sh)
