...
fn_31209_29493(){
    ...
    local fl_pth_fn_31209_29493="${HOME}/aer_foe/.d/.frp/make_005.frp/frp2dr.sh"
    local dr_pth_fn_31209_29493=$(dirname ${HOME}/aer_foe/.d/.frp/make_005.frp/frp2dr.sh)
    local fl_nm_fn_31209_29493=$(basename ${HOME}/aer_foe/.d/.frp/make_005.frp/frp2dr.sh)
    local rnd=31209_29493
    
    [[ "$1" == "-h" ]] && {
        echo -e "
        this -h for fl ::
        doing :: cp make_005.frp to dr
            exa use ::
            far use ::
        "
    }
