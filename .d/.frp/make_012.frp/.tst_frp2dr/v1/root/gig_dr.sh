...
fn_13390_7193() {
	...
	local pth_to_gig_sh_fn_13390_7193="${HOME}/aer_foe/.d/.frp/make_012.frp/.tst_frp2dr/v1/root/gig_dr.sh"
...
#SGN :: . ${HOME}/aer_foe/.d/.frp/make_012.frp/frp2dr.sh ${HOME}/aer_foe/.d/.frp/make_012.frp/.tst_frp2dr/v1/root
