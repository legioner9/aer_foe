...
fn_11604_52044() {
	...
	local sgn_fn_11604_52044="${pth_to_gig_sh_fn_11604_52044}"
	...
	local arg4_11604_52044="$4"

	sgn_fn_11604_52044=". $fl_pth_fn_11604_52044 ${arg1_11604_52044} ${arg2_11604_52044} ${arg3_11604_52044} ${arg4_11604_52044}"
	...
	#! ptr_path
	local result_dr="${arg1_11604_52044}"
	...
	cp -rv ${dr_pth_fn_11604_52044}/_.d ${result_dr} || return 1

	echo "cp -r ${dr_pth_fn_11604_52044}/_.f.d ${result_dr}"
	cp -rv ${dr_pth_fn_11604_52044}/_.f.d ${result_dr} || return 1

	if [[ -n "${arg3_11604_52044}" ]]; then

		echo "main.c -> ${arg3_11604_52044} as arg3"
		mv ${result_dr}/_.d/main.c ${result_dr}/_.d/${arg3_11604_52044}

		# l_02_s2f :: reciver_string: $1 inserter_string: $2 [@ - empty string] in reciver_result_file: $3
		l_02_s2f "main.c" ${arg3_11604_52044} ${result_dr}/_.d/makefile
		# l_02_fs2f ins.f {{body}} rcv.f
		l_02_fs2f "${HOME}/edu_clng/.d/.osdn/.hnt/clang.body.hnt" {{hint}} ${result_dr}/_.d/${arg3_11604_52044}
	...
	echo "#SGN :: #$sgn_fn_11604_52044"
	echo "#SGN :: $sgn_fn_11604_52044" >>${result_dr}/start.sh
