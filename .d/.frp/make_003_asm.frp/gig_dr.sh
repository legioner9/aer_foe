...
fn_11604_52044() {
    ...
    if [[ -n "${arg3_11604_52044}" ]]; then
        ...
        mv ${result_dr}/main.s ${result_dr}/${arg3_11604_52044}

        # l_02_s2f :: reciver_string: $1 inserter_string: $2 [@ - empty string] in reciver_result_file: $3
        l_02_s2f "main.s" ${arg3_11604_52044} ${result_dr}/makefile

        # l_02_fs2f ins.f {{body}} rcv.f
        l_02_fs2f "${HOME}/aer_foe/.d/.frp/make_003_asm.frp/_hint.asm/hint" {{hint}} ${result_dr}/${arg3_11604_52044}
