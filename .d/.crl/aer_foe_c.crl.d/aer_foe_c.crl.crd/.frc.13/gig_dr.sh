...
fn_13390_7193() {
	...
	local pth_to_gig_sh_fn_13390_7193="${HOME}/aer_foe/.d/.crl/aer_foe_c.crl.d/aer_foe_c.crl.crd/.frc.13/gig_dr.sh"
	...
	l_02_fs2f "${arg2_13390_7193}"/flow1.tst.ins {{body}} ${flow1_tst}
...
#DATE :: Сб 13 июн 2026 15:25:07 +07
#SGN :: . ${HOME}/aer_foe/.d/.frp/make_013.frp/frp2dr.sh ${HOME}/aer_foe/.d/.crl/aer_foe_c.crl.d/aer_foe_c.crl.crd/.frc.13
